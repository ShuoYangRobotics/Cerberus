...
void pubOdometry(const Estimator &estimator, const std_msgs::Header &header)
{
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        foutC
            ...
            << estimator.Bvs[WINDOW_SIZE].x() << ","         // 24
            << estimator.Bvs[WINDOW_SIZE].y() << ","         // 25
            << estimator.Bvs[WINDOW_SIZE].z() << ","         // 26
            << estimator.Bvs[WINDOW_SIZE].x() << ","         // 27
            << estimator.Bvs[WINDOW_SIZE].y() << ","         // 28
            << estimator.Bvs[WINDOW_SIZE].z() << ","         // 29
            << estimator.Bvs[WINDOW_SIZE].x() << ","         // 30
            << estimator.Bvs[WINDOW_SIZE].y() << ","         // 31
            << estimator.Bvs[WINDOW_SIZE].z() << ","         // 32
            << estimator.Bvs[WINDOW_SIZE].x() << ","         // 33
            << estimator.Bvs[WINDOW_SIZE].y() << ","         // 34
            << estimator.Bvs[WINDOW_SIZE].z() << ","         // 35
