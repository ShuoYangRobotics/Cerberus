...
class A1Kinematics {
    ...
    public:
        ...
        // jacobian   3x3
        Eigen::MatrixXd jac(Eigen::Vector3d q, Eigen::VectorXd rho_opt, Eigen::VectorXd rho_fix);
        // the partial derivative of fk wrt rho opt   3x3
        Eigen::MatrixXd dfk_drho(Eigen::Vector3d q, Eigen::VectorXd rho_opt, Eigen::VectorXd rho_fix);
        // the partial derivative of jacobian wrt q    9x3
        Eigen::MatrixXd dJ_dq(Eigen::Vector3d q, Eigen::VectorXd rho_opt, Eigen::VectorXd rho_fix);
        // the partial derivative of jacobian wrt rho opt   9x3
        Eigen::MatrixXd dJ_drho(Eigen::Vector3d q, Eigen::VectorXd rho_opt, Eigen::VectorXd rho_fix);
    private:
